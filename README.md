...
Демонстрационный проект backend-сервера платформы анонимных признаний IT-специалистов, реализованный с использованием FastAPI, SQLAlchemy 2.0 (PostgreSQL).

## Основные возможности

* **Аутентификация:** С использованием сессий, передача через HttpOnly куки.
* **Авторизация:** По модели RBAC (роли и разрешения).
...
* **Дополнительно:** Постраничная пагинация для списков элементов.
