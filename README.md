...
Демонстрационный проект backend-сервера платформы анонимных признаний IT-специалистов, реализованный с использованием фреймворка FastAPI.

## Основные возможности

* **Аутентификация:** Сессионная аутентификация с хранением session ID в HttpOnly cookie.
* **Авторизация:** Реализована на основе RBAC-модели (роли и разрешения).
