...
def upgrade() -> None:
    ...
    permissions = sa.table(
        ...
        sa.column("read_own_permission", sa.Boolean),
        sa.column("update_own_permission", sa.Boolean),
        sa.column("delete_own_permission", sa.Boolean),
        sa.column("description", sa.String),
    )
    ...
    op.bulk_insert(
        ...
        [
            ...
            },
            {
                ...
                "update_own_permission": True,
                "delete_own_permission": True,
                "description": "User: full access to confessions",
            },
        ],
    )
