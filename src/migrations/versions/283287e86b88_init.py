...
Revision ID: 283287e86b88
Revises: 
Create Date: 2026-04-21 20:39:04.166685
...
def upgrade() -> None:
    ...
    sa.Column('description', sa.String(length=250), nullable=True),
    sa.ForeignKeyConstraint(['business_element_id'], ['business_elements.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
